...
export async function rightExplorer(ctx){
 ...
 const imageKeys=imageNavigation(open);ctx.effect(()=>imageKeys.dispose());
 ...
 ctx.effect(wb.command('rightExplorer.revealFinder','右侧目录树 · 在 Finder 中显示',()=>info&&manage('reveal',selected)));
