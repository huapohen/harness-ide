export const fonts={overviewWidth:50,size:13,terminalSize:13,sidebarSize:13,family:'Menlo',cursorColor:'#c678dd',treeColor:'#abb2bf',markdownColor:'#b0b0b0',headingColor:'#8abebf'};
