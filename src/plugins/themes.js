export default {id:'themes',requires:['workbench'],activate(ctx,config){
 ...
 light:{label:'Light',terminal:{background:'#ffffff',foreground:'#383a42',cursor:'#526fff',black:'#383a42',red:'#e45649',green:'#50a14f',yellow:'#986801',blue:'#4078f2',magenta:'#a626a4',cyan:'#0184bc',white:'#fafafa'}}};
