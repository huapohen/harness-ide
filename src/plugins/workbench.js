...
export default {id:'workbench',requires:['api'],async activate(ctx){
 ...
 function select(t){if(!t)return;if(docked&&dockMaximized){lastDock=docked;docked=null;}if(docked===t||(t.group&&docked?.group===t.group))docked=null;active=t;render(root.querySelectorAll('.tab').length===tabs.length);t.focus?.();}
